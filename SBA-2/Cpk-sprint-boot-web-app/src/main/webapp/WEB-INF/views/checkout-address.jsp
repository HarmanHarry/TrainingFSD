	...
	<div class="alert bg-light" style="margin: 10px;">
		...
		<form:form action="${pageContext.request.contextPath }/user/finalize"
			...
			<div class="form-group">
				<form:label path="deliveryAddress">Enter Shipping Address :</form:label>
				<form:textarea path="deliveryAddress" class="form-control" />
				<form:errors path="deliveryAddress" class="alert alert-warning" />

			</div>


			<div class="form-group">
				<button class="btn-info">Place Order</button>
			</div>
		</form:form>
	</div>
