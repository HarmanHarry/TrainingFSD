...
public class User {
	...
	public User(int id, String personName, String email, String contactNumber, int totalAmount, String deliveryAddress,
			LocalDate orderDate, boolean orderFinalized) {
		super();
		this.id = id;
